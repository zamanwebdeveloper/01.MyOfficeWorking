...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2019 at 05:21 AM
...
(74, 'A41RUMVG', 'PRSHZTSK', 2, 1, 6, 3, '2019-03-19', 'Asma', 4, '2019-03-15', 1),
(75, 'A8YECLL9', 'P9YY1M8Y', 9, 1, 6, 1, '2019-03-19', 'Nothing But Something', 0, '2019-03-15', 1);
...
(9, 'Cardiology', 'Provides medical care to patients who have problems with their heart or circulation.', 1),
(10, 'Anesthetics', ' Doctors in this department give anesthetic for operations and procedures. An anesthetic is a drug or agent that produces a complete or partial loss of feeling. There are three kinds of anesthetic: general, regional and local.', 1),
(11, 'Admissions', 'At the Admitting Department, the patient will be required to provide personal information and sign consent forms before being taken to the hospital unit or ward. If the individual is critically ill, then, this information is usually obtained from a family member.', 1),
(12, 'Accident and emergency (A&E)', 'Also called Casualty Department, where you\'re likely to be taken if you have arrived in an ambulance or emergency situation.', 1);
...
(25, 'P0RV1QB2', 'Syed Zaman', 'Mostafiz', '01740301579', '01740301578', 'Shamoly, Dhaka-1205', 'Male', 'B+', '1995-02-27', NULL, 'assets/images/patient/2019-03-15/S2.jpg', 4, '2019-03-15', 1),
(26, 'PRSHZTSK', 'Syed Zaman', 'Mostafiz', '01740301579', '01740301578', 'sdfksdhkfkd', 'Male', 'B+', '2019-03-15', NULL, 'assets/images/patient/2019-03-15/S3.jpg', 4, '2019-03-15', 1),
(27, 'P9YY1M8Y', 'Syed Zaman', 'Mostafiz', '01740301579', '01740301578', 'Shamoly, Dhaka-1205', 'Male', 'B+', '1995-02-27', NULL, 'assets/images/patient/2019-03-15/S4.jpg', 2, '2019-03-15', 1);
...
(6, 1, '09:00:00', '12:00:00', 'Tuesday', '00:30:00', 2, 1),
...
(1, 'Samim', 'Khan', 'doctor@demo.com', 'afcba9ba4f956275ce89c46c515c2910', 2, '', 9, 'It is a long established fact that a reader will be distracted by the readable content ', '0123456798', '0123456798', '<p>It is a long established fact that a reader will be distracted by the readable content</p>', 'assets/images/doctor/2019-03-15/S1.jpg', '', '2016-10-12', 'Male', 'A+', '<p>It is a long established fact that a reader will be distracted by the readable content</p>', 2, '2019-03-15', NULL, 1),
(2, 'Syed Zaman', 'Mostafiz', 'admin@demo.com', '454141dab8fba2c55bc2d81247a629a4', 1, 'Web Developer', 3, 'Mollah Tower (5th Floor) 7 Link Road, Banglamotor, Dhaka- 1000', '01740301579', '01925166241', '<p>I am professional Web Developer</p>', 'assets/images/doctor/2019-03-16/S.jpg', 'PHP with Laravel Framework ', '1995-02-27', 'Male', 'B+', '', 2, '2019-03-16', NULL, 1),
(4, 'Reception ', 'Madam', 'reception@gmail.com', 'c1c881f895608667cb2d8fe570020c2c', 3, 'Frontent Developer', 1, '98 Green Road, Farmgate, Dhaka-1215', '0123456798', '1234567890', '<p>TEST</p>', 'assets/images/representative/2016-11-20/p1.png', 'MBBS', '2016-10-11', 'Male', 'B-', '<p>TEST</p>', 4, '2016-10-15', NULL, 1),
